...
gsm8k_task = LightevalTaskConfig(
    ...
    hf_repo="/mnt/data/kw/hjy/public_github/Long_to_short/data/test/gsm8k_test",
    hf_subset="default",
...
commonsenseqa_task = LightevalTaskConfig(
    ...
    hf_repo="/mnt/data/kw/hjy/public_github/Long_to_short/data/test/commonsense_qa_validation",
    hf_subset="default",
...
mmlu_pro_avg_task = LightevalTaskConfig(
    ...
    hf_repo="/mnt/data/kw/hjy/public_github/Long_to_short/data/test/MMLU_pro",
    hf_subset="default",
    hf_avail_splits=["test"],
    evaluation_splits=["test"],
    few_shots_split=None,
...
math_500_task = LightevalTaskConfig(
    ...
    suite=["community"],
    prompt_function=prompt_normal,
    hf_repo="/mnt/data/kw/hjy/public_github/Long_to_short/data/test/math500_dataset",
    hf_subset="default",
    hf_avail_splits=["test"],
    evaluation_splits=["test"],
    few_shots_split=None,
...
Olympiad_task = LightevalTaskConfig(
    ...
    hf_repo="/mnt/data/kw/hjy/public_github/Long_to_short/data/test/olympiad",
    hf_subset="default",
    hf_avail_splits=["test"],
    evaluation_splits=["test"],
    few_shots_split=None,
...
AMC_avg_task = LightevalTaskConfig(
    ...
    suite=["community"],
    prompt_function=prompt_normal_v2,
    hf_repo="/mnt/data/kw/hjy/public_github/Long_to_short/data/test/AMC",
    hf_subset="default",
    hf_avail_splits=["test"],
    evaluation_splits=["test"],
    few_shots_split=None,
...
aime24_avg_task = LightevalTaskConfig(
    ...
    suite=["community"],
    prompt_function=prompt_normal,
    hf_repo="/mnt/data/kw/hjy/public_github/Long_to_short/data/test/aime24_dataset",
    hf_subset="default",
    hf_avail_splits=["test"],
    evaluation_splits=["test"],
    few_shots_split=None,
