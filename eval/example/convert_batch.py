...
for j in range(110, 171, 10):
    # --- 配置 ---
    # 设置包含 Parquet 文件的输入目录
    INPUT_DIR = f"/mnt/data/kw/tom/main_experiments/0907_1.5B_main/step_{j}/results"
    # 设置保存 JSONL 文件的输出目录 (我们可以使用同一个目录)
    OUTPUT_DIR = f'/mnt/data/kw/tom/main_experiments/0907_1.5B_main/step_{j}/results'
