...
class RLHFDataset(Dataset):
    ...
    def _build_messages(self, example: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        if self.image_key in example:
            ...
            return [{"role": "system", "content": "You are a helpful AI assistant. A conversation takes place between the User and the Assistant. The User asks a question, and the Assistant solves it.\nPlease help me solve this question. Wrap only the final answer in \\boxed{}."},
